  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filtra solo le todolist completate
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <div className="flex items-center text-green-500">
          ...
          <span className="font-medium">Todolist Completate</span>
        </div>
      </div>

      <p className="text-gray-500">Visualizza lo storico delle attività completate</p>
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-lg border p-8 text-center">
          ...
          <h3 className="mt-2 text-lg font-medium text-gray-900">Nessuna todolist completata</h3>
          <p className="mt-1 text-sm text-gray-500">Non ci sono attività completate da visualizzare.</p>
                      ...
                      <div className="flex items-center">
                        <div className="flex -space-x-1">
                          {Array.from({ length: Math.min(3, todolist.count) }).map((_, i) => (
                            <div key={i} className="h-4 w-4 rounded-full border-2 border-white bg-green-200"></div>
                          ))}
                          {todolist.count > 3 && (
