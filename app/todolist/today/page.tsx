  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filter only today's todolists, excluding those completed and those with time slot already passed
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <div className="flex items-center text-blue-500">
          ...
          <span className="font-medium">Todolist di Oggi</span>
        </div>
      </div>

      <p className="text-gray-500">Visualizza e gestisci le attività pianificate per oggi</p>
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-lg border p-8 text-center">
          ...
          <h3 className="mt-2 text-lg font-medium text-gray-900">Nessuna todolist per oggi</h3>
          <p className="mt-1 text-sm text-gray-500">Non ci sono attività pianificate per la giornata di oggi.</p>
