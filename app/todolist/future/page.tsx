  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filtra solo le todolist future ed esclude quelle completate
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <div className="flex items-center text-orange-500">
          ...
          <span className="font-medium">Todolist Future</span>
        </div>
      </div>

      <p className="text-gray-500">Visualizza e gestisci le attività pianificate per date future</p>
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-lg border p-8 text-center">
          ...
          <h3 className="mt-2 text-lg font-medium text-gray-900">Nessuna todolist futura</h3>
          <p className="mt-1 text-sm text-gray-500">Non ci sono attività pianificate per date future.</p>
